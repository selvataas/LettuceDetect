...
Our model achieves the best scores throughout each data-type and overall, beating the previous best model (Finetuned LLAMA-2-13B) by a significant margin.
